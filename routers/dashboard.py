...
def _leer_y_normalizar(excel_path: str) -> pd.DataFrame:
    """Lee el Excel y normaliza Estado."""
...
def _resolver_excel(historial_id) -> str:
    """Retorna la ruta del Excel según historial_id o el más reciente."""
...
def get_dashboard(
    ...
    excel_path = _resolver_excel(historial_id)
...
def download_dashboard_filtrado(
    ...
    """Descarga el Excel con los filtros activos aplicados."""
    excel_path = _resolver_excel(historial_id)
